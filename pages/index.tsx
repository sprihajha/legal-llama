...
export default function Home() {
  ...
  const [messageState, setMessageState] = useState<{
    ...
    messages: [
      {
        message: 'Hi, what would you like to learn about the visas in USA?',
        type: 'apiMessage',
      },
    ],
    history: [],
    ...
    <>
      <Layout>
        <div className="mx-auto flex flex-col gap-4">
          ...
          {/*  <h2 className="font-bold text-lg mb-2">Lawyers Near Me</h2>*/}
          {/*  <div key={'ABC'} className="mb-2">*/}
          {/*    <h3 className="font-bold text-md">John Doe</h3>*/}
          {/*    <p>john.doe@gmail.com</p>*/}
          {/*    <p>555-555-5555</p>*/}
          {/*  </div>*/}
          {/*  <div key={'ABCc'} className="mb-2">*/}
          {/*    <h3 className="font-bold text-md">Jane Doe</h3>*/}
          {/*    <p>jane.doe@gmail.con</p>*/}
          {/*    <p>222-222-2222</p>*/}
          {/*  </div>*/}
          {/*  </div>*/}
          {/*</section>*/}
